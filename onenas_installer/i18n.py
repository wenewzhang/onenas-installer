...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "no_existing_system": "No existing system found.",
        "upgrade_confirmation_title": "Upgrade {vendor}",
        "proceed_upgrade": "The upgrade will not affect the original system. \nIt will only rebuild a new system and import the data from the original one.\nDo you want to proceed with the upgrade?",
        "upgrade_error": "Upgrade Error",
        "upgrade_succeeded": "Upgrade Succeeded",
        "upgrade_succeeded_msg": "The {vendor} upgrade succeeded!\\nPlease reboot the system.",
        "shell": "Shell",
    ...
    "zh": {
        ...
        "no_existing_system": "未找到现有系统。",
        "upgrade_confirmation_title": "找到了 {vendor}, 请确认是否升级:",
        "proceed_upgrade": "升级并不会影响原来的系统,升级仅会重建新系统,并且导入原系统的数据!",
        "upgrade_error": "升级错误",
        "upgrade_succeeded": "升级成功",
        "upgrade_succeeded_msg": "{vendor} 升级成功！\\n请重启系统。",
